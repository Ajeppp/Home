            ...
            <div class="flex flex-col justify-center bg-white border-white lg:w-1/4 p-5 drop-shadow-2xl rounded-lg"> 
                ...
                <form action="/cg" method="POST" class="grid justify-center">
                    ...
                    <div class="flex flex-col mt-2">
                        ...
                        <input type="date" name="date" id="date" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required>
                    </div>
                    <div class="flex flex-col mt-2">
                        <label for="time" class="text-[#000000]">CG Time</label>
                        <input type="time" name="time" id="time" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required>
                    </div>
                    <div class="flex flex-col mt-2">
                    ...
                    <div class="flex flex-col mt-2">
                        ...
                        <input type="text" name="location" id="location" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required>
                    </div>
