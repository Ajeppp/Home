    ...
    <div> --}}
        ...
        <div class="flex justify-center items-center h-screen">
            ...
            <div class="flex flex-col justify-center bg-white border-white lg:w-1/4 p-5 drop-shadow-2xl rounded-lg"> 
                ...
                <form action="/admin/user/{{ $user->id }}" method="POST" class="grid justify-center">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-col mt-2">
                        <label for="name" class="text-[#000000]">Name</label>
                        <input type="text" name="name" id="name" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required value="{{ $user -> name }}">
                    </div>
                    <div class="flex flex-col mt-2">
                        <label for="birthdate" class="text-[#000000]">Birth</label>
                        <input type="date" name="birthdate" id="birthdate" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required value="{{ $user -> birthdate }}">
                    </div>
                    <div class="flex flex-col mt-2">
                        <label for="phone" class="text-[#000000]">Phone</label>
                        <input type="text" name="phone" id="phone" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required value="{{ $user -> phone }}">
                    </div>
                    <div class="flex flex-col mt-2">
                        <label for="address" class="text-[#000000]">Address</label>
                        <input type="text" name="address" id="address" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required value="{{ $user -> address }}">
                    </div>
                    <div class="flex flex-col mt-2">
                        <label for="line" class="text-[#000000]">ID Line</label>
                        <input type="text" name="line" id="line" class="border-1  bg-[#D9D9D9] text-[#312626]  rounded-lg w-72 h-10 p-5" required value="{{ $user -> line }}">
                    </div>
