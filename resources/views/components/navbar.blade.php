<div class="bg-[#1F1D16] flex flex-row items-center justify-between py-3 px-3">
                    <div id="left-navbar" class="flex flex-row items-center">
                            <a href ="#">
                                <img src="https://gpdi-hebron.com/website/images/banner/gpdi-hebron-gading-serpong-41181523042016.png" width="80" height="80" alt="GPdI Hebron Gading Serpong">
                            </a>
                        <a href="#" class="text-white text-sm font-bold tracking-[8px]" aria-current="page">GPDI HEBRON</a>
                    </div>
                    <div id="right-navbar" class="flex flex-row gap-8 mr-5">
